...
<head>
    ...
    <title>Bauman - Creative Showcase Portfolio Template</title>
        ...
        <div class="cd-index cd-main-content">
            ...
            <div id="page-content" class="light-content">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Deals Application</h2>
                                                    <h4 class="carousel-cat">Web Design</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Opulence Cosmetics</h2>
                                                    <h4 class="carousel-cat">Branding</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Gillemore Gin</h2>
                                                    <h4 class="carousel-cat">Packaging Design</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Gold Man Watching</h2>
                                                    <h4 class="carousel-cat">How to melt Metal</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Sombre Forest</h2>
                                                    <h4 class="carousel-cat">Photography</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Verhelst Concrete</h2>
                                                    <h4 class="carousel-cat">Branding Design</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Tin The Woddman</h2>
                                                    <h4 class="carousel-cat">CGI Experiment</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Sapfo Olive Oil</h2>
                                                    <h4 class="carousel-cat">Product Design</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="carousel-caption">
                                                    <h2 class="carousel-title">Forest House</h2>
                                                    <h4 class="carousel-cat">Architecture</h4>
                                                </div>
                                            </div>
                                            <!--/Section Slide -->
                ...
                <div class="thumb-container">
                    ...
                    <div class="thumb-page" data-src="images/07hero.jpg"></div>
                    <div class="thumb-page" data-src="images/08hero.jpg"></div>
                    <div class="thumb-page" data-src="images/09hero.jpg"></div>
                </div>
